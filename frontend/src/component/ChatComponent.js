...
//   const {
//     messages: reduxMessages = [], // Messages from Redux
//     loading,
//     error,
...
//   useEffect(() => {
//     if (reduxMessages.length > 0 && JSON.stringify(reduxMessages) !== JSON.stringify(localMessages)) {
//       setLocalMessages(reduxMessages);
//     }
//   }, [reduxMessages]); // Sync Redux state to local state when reduxMessages change
...
//     // Update localMessages immediately to show the new message in the UI
//     setLocalMessages((prevMessages) => [...prevMessages, newMessageObject]);

//     // Dispatch action to send the message to the backend and update Redux state
...
//     },
//     messagesContainer: {
//       display: "flex", // Add this for flex layout
//       flexDirection: "column", // Ensures messages stack vertically
//       flex: 1,
//       overflowY: "auto",
//       padding: "10px",
...
//         <h3 style={{ margin: "0 0 15px 0", color: "#7E60BF" }}>Admins</h3>
//         {adminList.map((admin) => (
//           <div
//           key={admin.adminId}
//           style={{
...
//           }}
//           onMouseEnter={(e) => {
//             e.currentTarget.style.backgroundColor = "#e0e0ff"; // Light hover effect
//             e.currentTarget.style.boxShadow = "0px 4px 10px rgba(0, 0, 0, 0.2)"; // Hover shadow
//           }}
//           onMouseLeave={(e) => {
//             e.currentTarget.style.backgroundColor =
//               selectedAdminId === admin.adminId ? "#d6d6f5" : "white"; // Revert to default
