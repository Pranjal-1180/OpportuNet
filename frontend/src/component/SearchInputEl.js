      ...
      <div style={{ display: "flex", justifyContent: "center" }}>
        ...
        <button
          ...
          style={{
            ...
            borderRadius: "4px",
            cursor: "pointer",
            transition: "all 0.1s ease", // Smooth transition for all styles
          }}
          onMouseEnter={(e) => {
            e.target.style.backgroundColor = "#7E60BF"; // Darker shade for hover
            e.target.style.transform = "scale(1.1)"; // Slightly enlarge the button
          }}
          onMouseLeave={(e) => {
            e.target.style.backgroundColor = "#87A2FF"; // Restore original color
