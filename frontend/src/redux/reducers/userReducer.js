...
export const userReducerEdit = (state = { user: null, success: false }, action) => {
    switch (action.type) {
        case USER_EDIT_REQUEST:
            return { ...state, loading: true, success: false }; // Reset success flag on request
        case USER_EDIT_SUCCESS:
            return {
                loading: false,
                user: action.payload.user, // Use the updated user data from action payload
                success: true, // Set success to true
            };
        case USER_EDIT_FAIL:
            return {
                loading: false,
                error: action.payload, // Set error, don't overwrite the existing user data
                success: false, // Reset success on failure
            };
        case USER_EDIT_RESET: // Add a case to reset the state
            return { user: null, success: false }; // Reset the user and success state
        default:
            return state;
    }
};
    ...
    switch (action.type) {
        ...
        case USER_UPLOAD_RESUME_SUCCESS:
            return {
                loading: false,
                success: true,
                message: action.payload.message, // Assuming the API returns a success message
            };
